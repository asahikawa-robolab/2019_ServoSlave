...
#define REG_for_RX RC1REG                  ////受信レジスタ////
#define Buffer_from_master Buffer0              ////Buffer////
#define Data_from_master RxData0                ////RxData////
#define FLAG_FERR RC1STAbits.FERR        ////フレーミングエラーフラグ////
#define FLAG_OERR RC1STAbits.OERR        ////オーバーランエラーフラグ////
#define ContinuousRXEnable RC1STAbits.CREN        ////連続的な受信許可ビット////
